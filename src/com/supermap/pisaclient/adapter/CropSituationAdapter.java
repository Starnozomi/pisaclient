...
public class CropSituationAdapter extends BaseAdapter {
		...
		public CropSituationAdapter(Context context,List<AgrInfo> list){
...
//			praisesList = mCityDao.getAgrPraises(agrInfo.agrInfoId);
			...
			viewHolder.lv_comments.setAdapter(new CropInListAdapter(mContext, commentsList, agrInfo));
