...
public class FarmAdvisoryQuestionAdapter extends BaseAdapter {
		...
		private FarmAdvisoryQuestionCommentAdapter mCommentAdapter;
		
		
		public FarmAdvisoryQuestionAdapter(Context context,List<AdvisoryInfo> list){
...
//			}
			mCommentAdapter = new FarmAdvisoryQuestionCommentAdapter(mContext, commentsList,position);
...
//				int y = location[1]-(contentView.getMeasuredHeight()-view.getMeasuredHeight());
		 ...
		 private void refreshPraise(){
			 List<AdvPraise> advPraises = mDataList.get(mAdvinfoPositon).mPraises;
				...
				FarmAdvisoryQuestionAdapter.this.notifyDataSetChanged();
		 }
