 ...
 *
 */
public class FarmAdvisoryQuestionCommentAdapter extends BaseAdapter {
	...
	**/
	...
	public FarmAdvisoryQuestionCommentAdapter(Context context, List<AdvinfoComment> list,int outPositon) {
...
//				updateScoreButton(false, mItemIndex);
				...
				FarmAdvisoryQuestionCommentAdapter.this.notifyDataSetChanged();
//				refresh();
//				没有起作用
