...
public class DragGridView extends GridView{
	...
	public boolean dispatchTouchEvent(MotionEvent ev) {
		...
		case MotionEvent.ACTION_DOWN:
			...
			if((mDragPosition == AdapterView.INVALID_POSITION)||((mDragPosition - getFirstVisiblePosition()+1)==this.getChildCount())){
	...
	private void onSwapItem(int moveX, int moveY){
		...
		if(tempPosition != mDragPosition && tempPosition != AdapterView.INVALID_POSITION){
			...
			getChildAt(tempPosition - getFirstVisiblePosition()).setVisibility(View.INVISIBLE);//拖动到了新的item,新的item隐藏
