...
public class PreferencesService {
    ...
    public void saveCropLastRefreshTime(int userId,String lastRefreshTime) {
        SharedPreferences preferences = context.getSharedPreferences("crops_refresh_time", Context.MODE_PRIVATE);
        Editor editor = preferences.edit();
        editor.putString(String.valueOf(userId), lastRefreshTime);
        editor.commit();
    }
    
    public String getCropLastRefreshTime(int userId){
    	SharedPreferences preferences = context.getSharedPreferences("crops_refresh_time", Context.MODE_PRIVATE);
        return preferences.getString(String.valueOf(userId),Constant.DEFAULT_RESHREN_TIME);
    }
