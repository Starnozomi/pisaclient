...
//			drawRemindNum(R.id.rad_situation, mBinder.getmCrops_Remind_num());
	...
	private void initBadageView(){
		mWeather_badge = new BadgeView(BaseMapActivity.this, mLlWeather);
		mWeather_badge.setTextSize(CommonUtil.dipToPixels(BaseMapActivity.this, 5));
		mWeather_badge.hide();
		
		mCrops_badge = new BadgeView(BaseMapActivity.this, mLlSituation);
//		mCrops_badge.setBackgroundResource(R.drawable.badge_ifaux);
		mCrops_badge.hide();
		
		mMore_badge = new BadgeView(BaseMapActivity.this, mLlMore);
		mMore_badge.setTextSize(CommonUtil.dipToPixels(BaseMapActivity.this, 5));
...
//	}
	...
	protected void onResume() {
		Intent bindIntent = new Intent(BaseMapActivity.this, PisaService.class);
