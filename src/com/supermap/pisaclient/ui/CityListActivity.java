...
import com.supermap.pisaclient.adapter.CityAdapter;
import com.supermap.pisaclient.dao.CityData;
import com.supermap.pisaclient.entity.CityItem;
import com.supermap.pisaclient.grouplist.ContactItemInterface;
import com.supermap.pisaclient.grouplist.ContactListViewImpl;
...
public class CityListActivity extends Activity implements TextWatcher
{
	...
	public void onCreate(Bundle savedInstanceState)
	{
		...
		CityAdapter adapter = new CityAdapter(this,R.layout.group_city_item, contactList);
