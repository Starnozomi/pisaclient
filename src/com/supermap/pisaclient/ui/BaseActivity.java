...
//			drawRemindNum(R.id.rad_situation, mBinder.getmCrops_Remind_num());
	...
	private void initBadageView(){
		mWeather_badge = new BadgeView(BaseActivity.this, mLlWeather);
		mWeather_badge.setTextSize(CommonUtil.dipToPixels(BaseActivity.this, 5));
		mWeather_badge.hide();
		
		mCrops_badge = new BadgeView(BaseActivity.this, mLlSituation);
//		mCrops_badge.setBackgroundResource(R.drawable.badge_ifaux);
		mCrops_badge.hide();
		
		mMore_badge = new BadgeView(BaseActivity.this, mLlMore);
		mMore_badge.setTextSize(CommonUtil.dipToPixels(BaseActivity.this, 5));
...
//	}
	...
	protected void onResume() {
		Intent bindIntent = new Intent(BaseActivity.this, PisaService.class);
