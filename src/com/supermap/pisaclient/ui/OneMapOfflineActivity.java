...
public class OneMapOfflineActivity extends BaseActivity implements MKOfflineMapListener
{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setIsBack(true);
		setTvTitle(Utils.getString(this, R.string.one_map_offline));
		
		mContent = inflater(R.layout.onemap_offline);
	...
	private void initView() {
        ...
        cidView = (TextView) mContent.findViewById(R.id.cityid);
        cityNameView = (EditText) mContent.findViewById(R.id.city);
        stateView = (TextView) mContent.findViewById(R.id.state);

        ListView hotCityList = (ListView) mContent.findViewById(R.id.hotcitylist);
        ...
        ListView allCityList = (ListView) mContent.findViewById(R.id.allcitylist);
        // 获取所有支持离线地图的城市
        ...
        LinearLayout cl = (LinearLayout) mContent.findViewById(R.id.citylist_layout);
        LinearLayout lm = (LinearLayout) mContent.findViewById(R.id.localmap_layout);
        ...
        ListView localMapListView = (ListView) mContent.findViewById(R.id.localmaplist);
    ...
    public class LocalMapAdapter extends BaseAdapter {
        ...
        public View getView(int index, View view, ViewGroup arg2) {
            ...
            view = View.inflate(OneMapOfflineActivity.this,
