...
public class DefaultClusterRenderer<T extends ClusterItem> implements
    ...
    private com.baidu.mapapi.clusterutil.ui.SquareTextView makeSquareTextView(Context context) {
        ...
        squareTextView.setVisibility(View.GONE);//隐藏聚合点
    ...
    /**
     * 这个主要是对非聚合点进行的操作，本项目中不需要对聚合点实现点击事件的响应
    ...
    protected void onBeforeClusterItemRendered(T item, MarkerOptions markerOptions) {
    	...
    	{
    		markerOptions.extraInfo(item.getExtraInfo());//添加额外的信息
    	}
    }
    ...
    protected void onClusterItemRendered(T clusterItem, Marker marker) {
    	/*if(clusterItem.getExtraInfo()!=null)
    	{
    		marker.setExtraInfo(clusterItem.getExtraInfo());//添加额外的信息
    	}*/
    }
